...
$this->breadcrumbs=array(
		'แจ้งหนังสือไม่เหมาะสม  :: เรื่อง '.$general->name,
);
?>
...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($general,'name'); ?>
		<?php echo $form->textField($general,'name',array('readonly' => true)); ?>
		<?php echo $form->error($general,'name'); ?>
	</div>
	
	<div class="row">
		<?php echo $form->labelEx($general,'comment'); ?>
