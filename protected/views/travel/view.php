...
<?php 
	$this->breadcrumbs=array(
			'ท่องเที่ยว'=>array('travel'),
			'ชื่อหนังสือ '.$travel->name,
			
	);
?>
<h2><?php echo $travel->name; ?></h2>
		<br />
		<center><?php if($travel->picture != null){?>
		<img  width="270" height="360"  src="/bls_project1/images/book_img/<?php echo $travel->picture?>"></img>
		<?php }?></center>
		<br />
		<font color = "#0000ff">วันที่สร้าง : <?php echo $travel->create_date; ?> </font>
		<br />
		<?php echo $IdBook = $travel->id ; ?>
		<font color = "#0000ff">นามปากกา: <?php //echo $IdBook = $healthAndBeauty->alias ; ?> </font>
		<br />
		<br />
		รายละเอียด: <?php echo $travel['description']; ?> </center>
		<br />
		<br />
	...
	'label'=>'ย้อนกลับ',
	'url'=>'index.php?r=travel/travel',
	)); ?>
	
	
	<?php $this->widget('bootstrap.widgets.TbButton', array(
	'label'=>'แจ้งหนังสือไม่เหมาะสม',
	'url'=>'index.php?r=travel/reportBook&id='.$travel->id,
	)); ?>
	
	<?php $this->widget('bootstrap.widgets.TbButton', array(
	'label'=>'เพิ่มไปยังชั้นวางหนังสือ',
	'url'=>'index.php?r=bookshelf/index&id='.$travel->id,
	)); ?>
    </div>
...
if ($connect->query($query) === TRUE) {
	...
	$redirectUrl = '/bls_project1/index.php?r=/travel/view&id='.$travel->id;	
