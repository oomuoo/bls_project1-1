...
<?php 
	$this->breadcrumbs=array(
			'ดูข้อมูลส่วนตัว'=>array('view','id'=>$user->id),
			$user->username
	);

	$this->menu=array(
		array('label'=>'ดูข้อมูลส่วนตัว', 'url'=>array('view', 'id'=>$user->id)),
		//array('label'=>'ลบข้อมูลส่วนตัว','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$user->id),'confirm'=>'จะลบไม่ลบ')),
		);
?>
