...
class Book extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, create_date, update_date, description, category_id, picture, status, member_id, score_id, type_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'file' => 'ไฟล์หนังสือที่ต้องการอัพโหลด',
		);
	}
