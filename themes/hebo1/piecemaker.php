...
<Piecemaker>
  <Contents>
  	<Image Source="'.$_GET['path'].'/img/slider/flickr/s10.jpg" Title="Editing made Easy"></Image>
  	<Image Source="'.$_GET['path'].'/img/slider/flickr/s15.jpg" Title="Editing made Easy"></Image>
	<Image Source="'.$_GET['path'].'/img/slider/flickr/s11.jpg" Title="Editing made Easy"></Image>
	<Image Source="'.$_GET['path'].'/img/slider/flickr/s12.jpg" Title="Editing made Easy"></Image>
	<Image Source="'.$_GET['path'].'/img/slider/flickr/s14.jpg" Title="Editing made Easy"></Image>
  </Contents>
