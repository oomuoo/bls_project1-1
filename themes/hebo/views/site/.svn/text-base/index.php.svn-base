    	...
    	<div class="slider-wrapper theme-default">
            <div id="slider-nivo" class="nivoSlider">
                ...
                <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/s13.jpg" data-thumb="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/s13.jpg" alt="" title="" />
                 <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/s14.jpg" data-thumb="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/s14.jpg" alt="" title=""  />
                <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/s15.jpg" data-thumb="<?php echo Yii::app()->theme->baseUrl;?>/img/slider/flickr/s15.jpg" alt="" title="" />
            </div>
        </div>
