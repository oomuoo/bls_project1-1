...
<div id="menu">
        <?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'News', 'url'=>array('/site/page', 'view'=>'about')),
				array('label'=>'How to create', 'url'=>array('/site/contact')),
				array('label'=>'Register', 'url'=>array('/member/create'), 'visible'=>Yii::app()->user->isGuest),
				array('label'=>'Create E-books', 'url'=>array('/student/index'), 'visible'=>!Yii::app()->user->isMember()),
				array('label'=>'Members Management', 'url'=>array('/student/index'), 'visible'=>!Yii::app()->user->isMember()),
